...
type TodoService interface {
	...
	DeleteTodo(todo *entity.Todo) (*mongo.DeleteResult, error)
}
...
func (ts *todoService) DeleteTodo(todo *entity.Todo) (*mongo.DeleteResult, error) {
	return ts.Repo.DeleteTodo(todo)
}
